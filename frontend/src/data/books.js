...
export const books = [
  {
    ...
    saves: 842,
    growth: "+18%",
    reason: "최근 인문 분야에서 저장 수가 빠르게 늘고 있습니다.",
    summary: "정보가 많은 시대에 깊이 읽는 감각을 회복하는 방법을 다룹니다.",
    keywords: ["독서", "사유", "집중"],
    cover: "bg-[#1E2A38]",
  },
  {
  ...
  },
  {
    ...
    saves: 683,
    growth: "+31%",
    reason: "도파민, 집중 키워드와 함께 탐색량이 증가했습니다.",
    summary: "스마트폰과 업무 사이에서 주의력을 지키는 실용적인 전략을 제안합니다.",
    keywords: ["도파민", "집중", "루틴"],
    cover: "bg-[#F59E0B]",
  },
  {
    ...
    saves: 534,
    growth: "+16%",
    reason: "리뷰 수와 상세 페이지 조회가 함께 늘었습니다.",
