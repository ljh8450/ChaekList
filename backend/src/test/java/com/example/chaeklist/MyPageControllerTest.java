...
class MyPageControllerTest {
	...
	private void insertCompletedReadingRoom(long userId, long bookId, String completedAt) {
		jdbcTemplate.update("""
				...
				VALUES (?, ?, '완료된 모각독', '2026-04-24 08:00:00', '2026-04-24 09:00:00', 5, 'RECRUITING', 'PUBLIC', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP)
				""", userId, bookId);
		...
		jdbcTemplate.update("""
				...
				VALUES (?, ?, 'COMPLETED', '2026-04-24 08:00:00', ?)
				""", roomId, userId, completedAt);
	}
